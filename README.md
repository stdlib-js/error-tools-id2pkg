...
```javascript
import id2pkg from 'https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-id2pkg@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/error-tools-id2pkg/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/error-tools-id2pkg/actions/workflows/test.yml?query=branch:v0.2.0
