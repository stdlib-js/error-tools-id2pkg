...
```javascript
id2pkg = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-id2pkg@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-id2pkg@v0.2.1-umd/browser.js"></script>
```
